  ...
  if (active && payload && payload.length) {
    return (
      ...
      >
        ...
        <motion.div 
          className="w-full h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-3"
          initial={{ scaleX: 0 }}
          animate={{ scaleX: 1 }}
...
export function ConversionsBarChart({ data, loading = false }) {
      ...
      >
        <Card className="relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 rounded-3xl shadow-xl animate-pulse">
          <CardHeader className="pb-4">
            <div className="h-6 w-40 bg-gray-200 dark:bg-gray-700 rounded-lg shimmer mb-2"></div>
        ...
        <CardHeader className="pb-6 relative z-10">
          <div className="flex items-center justify-between">
            ...
            <motion.div
              ...
              className="flex items-center space-x-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-purple-200/50 dark:border-purple-800/50 px-3 py-2 rounded-xl"
            >
          ...
          >
            <ResponsiveContainer width="100%" height={300}>
              <BarChart 
                ...
                onMouseMove={(e) => {
                  if (e.activePayload) {
                    setHoveredBar(e.activePayload[0])
                  }
                }}
              ...
              >
                <defs>
                  ...
                  <linearGradient id="colorConversionsHover" x1="0" y1="0" x2="0" y2="1">
